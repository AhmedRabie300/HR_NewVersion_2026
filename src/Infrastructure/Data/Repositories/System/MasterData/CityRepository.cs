...
namespace Infrastructure.Data.Repositories.System.MasterData
{
    public sealed class CityRepository : ICityRepository
    {
        ...
        public async Task<City?> GetByCodeAsync(string code)
            => await _db.Cities.FirstOrDefaultAsync(x => x.Code == code);
        ...
        public async Task<List<City>> GetByCountryIdAsync(int countryId)
            => await _db.Cities
        ...
        public async Task<List<City>> GetByRegionIdAsync(int regionId)
            => await _db.Cities
        ...
        public async Task DeleteAsync(int id)
        {
            ...
            if (item != null) _db.Cities.Remove(item);
        }

        public async Task<bool> ExistsAsync(int id)
            => await _db.Cities.AnyAsync(x => x.Id == id);

        public async Task<bool> CodeExistsAsync(string code)
            => await _db.Cities.AnyAsync(x => x.Code == code);

        public async Task<bool> CodeExistsAsync(string code, int excludeId)
            => await _db.Cities.AnyAsync(x => x.Code == code && x.Id != excludeId);

        public async Task<PagedResult<City>> GetPagedAsync(int pageNumber, int pageSize, string? searchTerm)
        {
            ...
            return new PagedResult<City>(items, pageNumber, pageSize, totalCount);
        }
