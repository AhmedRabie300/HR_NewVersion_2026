...
namespace Application.System.MasterData.DocumentTypesGroup.Validators
{
    public class CreateDocumentTypesGroupValidator : AbstractValidator<CreateDocumentTypesGroupDto>
    {
        ...
        public CreateDocumentTypesGroupValidator(IValidationMessages msg,IDocumentTypesGroupRepository repo)
        {
            _repo = repo;
...
.WithMessage(x => msg.Format("CodeExists", msg.Get("DocumentTypesGroup"), x.Code));
