...
namespace Application.System.MasterData.DependantType.Validators
{
    public class CreateDependantTypeValidator : AbstractValidator<CreateDependantTypeDto>
    {
        ...
        public CreateDependantTypeValidator(IValidationMessages msg,IDependantTypeRepository repo)
        {
            _repo = repo;
            RuleFor(x => x.Code)
...
.WithMessage(x => msg.Format("CodeExists", msg.Get("DependantType"), x.Code));
