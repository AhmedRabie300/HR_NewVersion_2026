...
namespace Application.System.MasterData.ContractType.Validators
{
    public class UpdateContractTypeValidator : AbstractValidator<UpdateContractTypeDto>
    {
        ...
        public UpdateContractTypeValidator(ILocalizationService localizer, IContextService ContextService)
        {
            ...
            RuleFor(x => x.IsSpecial)
                ...
                .WithMessage(x => _localizer.GetMessage("IsSpecialRequired", _ContextService.GetCurrentLanguage()));
