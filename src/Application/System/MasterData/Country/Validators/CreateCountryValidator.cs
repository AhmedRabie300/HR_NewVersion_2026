...
namespace Application.System.MasterData.Country.Validators
{
    public class CreateCountryValidator : AbstractValidator<CreateCountryDto>
    {
        public CreateCountryValidator(ILocalizationService localizer, IContextService contextService)
        {
            ...
            RuleFor(x => x.EngName)
                .MaximumLength(255).WithMessage(string.Format(localizer.GetMessage("MaxLength", lang), 255));
            ...
            RuleFor(x => x.ISOAlpha2)
                .MaximumLength(2).WithMessage(string.Format(localizer.GetMessage("MaxLength", lang), 2));

            RuleFor(x => x.ISOAlpha3)
                .MaximumLength(3).WithMessage(string.Format(localizer.GetMessage("MaxLength", lang), 3));
            ...
            RuleFor(x => x.CurrencyId)
                ...
                .WithMessage(localizer.GetMessage("CurrencyRequired", lang));

            RuleFor(x => x.NationalityId)
                .GreaterThan(0).When(x => x.NationalityId.HasValue)
                .WithMessage(localizer.GetMessage("NationalityRequired", lang));
            ...
            RuleFor(x => x.CapitalId)
                ...
                .WithMessage(localizer.GetMessage("CapitalRequired", lang));
