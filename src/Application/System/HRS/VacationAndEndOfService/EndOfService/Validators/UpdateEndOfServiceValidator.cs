...
{
    public class UpdateEndOfServiceValidator : AbstractValidator<UpdateEndOfServiceDto>
    {
        private readonly IEndOfServiceRepository _repo;

        public UpdateEndOfServiceValidator(IValidationMessages msg, IEndOfServiceRepository repo)
        {
            _repo = repo;
        ...
        private bool HaveAtLeastOneField(UpdateEndOfServiceDto dto)
        {
            return dto.Code != null ||
                   ...
                   dto.ArbName4S != null ||
                   dto.Remarks != null ||
                   dto.ExtraTransactionId.HasValue ||
