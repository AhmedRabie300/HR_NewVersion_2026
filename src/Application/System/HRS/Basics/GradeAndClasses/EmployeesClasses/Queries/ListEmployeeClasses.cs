...
{
    public static class ListEmployeeClasses
    {
        public record Query : IRequest<List<EmployeeClassDto>>;

        public class Handler : IRequestHandler<Query, List<EmployeeClassDto>>
        {
            ...
            public async Task<List<EmployeeClassDto>> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                return items.Select(x => new EmployeeClassDto(
                    Id: x.Id,
                    Code: x.Code,
                    EngName: x.EngName,
                    ArbName: x.ArbName,
