...
{
    public class UpdateContractsTypeValidator : AbstractValidator<UpdateContractsTypeDto>
    {
        private readonly IContractsTypeRepository _repo;

        public UpdateContractsTypeValidator(IValidationMessages msg, IContractsTypeRepository repo)
        {
            _repo = repo;
        ...
        private bool HaveAtLeastOneField(UpdateContractsTypeDto dto)
        {
