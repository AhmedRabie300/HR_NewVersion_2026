...
namespace Application.System.HRS.Basics.Items.Validators
{
    public class UpdateItemValidator : AbstractValidator<UpdateItemDto>
    {
        ...
        public UpdateItemValidator(IValidationMessages msg, IItemRepository repo)
        {
            _repo = repo;
            ...
            RuleFor(x => x.EngName)
                .MaximumLength(500).When(x => x.EngName != null)
                .WithMessage(x => msg.Format("MaxLength", 500))
            ...
            RuleFor(x => x.ArbName)
                .MaximumLength(500).When(x => x.ArbName != null)
                .WithMessage(x => msg.Format("MaxLength", 500))
            ...
            RuleFor(x => x.ArbName4S)
                .MaximumLength(500).When(x => x.ArbName4S != null)
                .WithMessage(x => msg.Format("MaxLength", 500));
            ...
            RuleFor(x => x.LicenseNumber)
                .MaximumLength(100).When(x => x.LicenseNumber != null)
        ...
        private bool HaveAtLeastOneField(UpdateItemDto dto)
        {
            return dto.Code != null ||
                   dto.EngName != null ||
                   dto.ArbName != null ||
                   dto.ArbName4S != null ||
                   dto.PurchaseDate.HasValue ||
                   dto.PurchasePrice.HasValue ||
                   dto.ExpiryDate.HasValue ||
                   dto.LicenseNumber != null ||
                   dto.IsFromAssets.HasValue ||
                   dto.Remarks != null;
        }
    }
}