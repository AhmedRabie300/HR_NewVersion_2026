...
namespace Application.System.HRS.Basics.FiscalYears.Validators
{
    public class UpdateFiscalYearValidator : AbstractValidator<UpdateFiscalYearDto>
    {
        private readonly IFiscalYearRepository _repo;

        public UpdateFiscalYearValidator(IValidationMessages msg, IFiscalYearRepository repo)
        {
            _repo = repo;
        ...
        private bool HaveAtLeastOneField(UpdateFiscalYearDto dto)
        {
