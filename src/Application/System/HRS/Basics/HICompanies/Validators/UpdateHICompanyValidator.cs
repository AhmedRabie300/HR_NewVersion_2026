...
{
    public class UpdateHICompanyValidator : AbstractValidator<UpdateHICompanyDto>
    {
        private readonly IHICompanyRepository _repo;

        public UpdateHICompanyValidator(IValidationMessages msg, IHICompanyRepository repo)
        {
            _repo = repo;
            ...
            RuleFor(x => x.Code)
                .MaximumLength(100).When(x => x.Code != null)
        ...
        private bool HaveAtLeastOneField(UpdateHICompanyDto dto)
        {
