...
namespace Application.System.HRS.VacationsPaidType.Commands
{
    ...
    {
        public record Command(CreateVacationsPaidTypeDto Data) : IRequest<int>;
                ...
                ICompanyRepository companyRepo)
            {
                ...
                RuleFor(x => x.Data)
                    .CustomAsync(async (data, context, ct) =>
                    {
                        ...
                        var validator = new CreateVacationsPaidTypeValidator(_localizer, _contextService);
        ...
        public class Handler : IRequestHandler<Command, int>
        {
            ...
            public async Task<int> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var company = await _companyRepo.GetByIdAsync(companyId);
                if (company == null)
                    throw new NotFoundException("Create VacationsPaidType", string.Format(
